...
function Hero() {
  return (
    <div className='mt-10 sm:mt-10'>
      <section className="hero sm:px-[100px] px-4 sm:mb-16 mb-8 mx-auto">
        <div className="flex flex-col items-center justify-center w-full h-full p-0 gap-y-8 lg:flex-row gap-x-10">
          
          <div className='flex flex-col gap-y-8'>
            <h2 className="text-3xl sm:text-4xl sm:mt-6 text-[#033B6C] font-bold max-w-sm">Networking is a <span className='text-[#2F80ED] font-bold'>TWO-WAY STREET</span>, let us connect you with the right people.</h2>
          ...
          <img src="./images/ultra.png" className="w-full max-w-md" alt='hero'/>
        </div>
      </section>
